...
class Zend_Gdata_HttpClient extends Zend_Http_Client
{
    ...
    /**
     * TOKEN POUR OAUTH (AJOUTE PAR LUDO)
     * Enter description here ...
     * @var unknown_type
     */
    private $_oAuthAccessToken = null;
    ...
    public function filterHttpRequest($method, $url, $headers = array(), $body = null, $contentType = null) {
        ...
        } elseif ($this->getOAuthAccessToken() != null) {
        	$headers['Authorization'] = 'Bearer ' . $this->getOAuthAccessToken();
        }
