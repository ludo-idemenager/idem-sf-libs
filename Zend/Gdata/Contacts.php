...
class Zend_Gdata_Contacts extends Zend_Gdata {
	...
	public function getContactEntry($user, $contactId) {
        return parent::getEntry(
        	"https://www.google.com/m8/feeds/contacts/".urlencode($user)."/full/".$contactId,
        	'Zend_Gdata_Contacts_ContactEntry'
       	);
    }
    
	public function updateContact($contact, $user, $contactId) {
        $updatedContact = $this->updateEntry(
        	$contact, 
        	"https://www.google.com/m8/feeds/contacts/".urlencode($user)."/full/".$contactId,
        	'Zend_Gdata_Contacts_ContactEntry'
        );
